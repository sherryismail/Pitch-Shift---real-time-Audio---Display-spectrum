...
namespace OpenC_Demo
{
    public class PitchProcessing
    {
        ...
        private static Fourier myfourier = new Fourier();//localfourier
        #endregion
            ...
            long osamp, float sampleRate, float[] indata)
        {
            ...
            FourierArrays farray = new FourierArrays((int)fftFrameSize);
            ...
            for (i = 0; i < sampleCount; i++)
            {
                ...
                if (gRover >= fftFrameSize)
                {
                    ...
                    for (k = 0; k < fftFrameSize; k++)
                    {
                        ...
                        //localfourier
                        //farray.time_re[k] = (float)(gInFIFO[k]);
                        //farray.time_im[k] = 0;
                    }
                    ...
                    //localfourier
                    //Array.Clear(farray.freq_re, 0, (int)fftFrameSize);
                    //Array.Clear(farray.freq_im, 0, (int)fftFrameSize);
                    //myfourier.fft("forward", "rect", farray.time_re, farray.time_im, farray.freq_re, farray.freq_im, (int)fftFrameSize);
                    ...
                    for (k = 0; k <= fftFrameSize2; k++)
                    {
                        ...
                        //localfourier
                        //real = farray.freq_re[k];
                        //imag = farray.freq_im[k];
                    ...
                    for (k = 0; k <= fftFrameSize2; k++)
                    {
                        ...
                        //localfourier
                        //farray.freq_re[k] = (float)(magn * Math.Cos(phase));
                        //farray.freq_im[k] = (float)(magn * Math.Sin(phase));
                    }
                    ...
                    ShortTimeFourierTransform(gFFTworksp, fftFrameSize, 1);
                    // =========== take mirror and make the array = N in size==================
                    //localfourier
                    //Array.Clear(farray.time_re, 0, (int)fftFrameSize);
                    //Array.Clear(farray.time_im, 0, (int)fftFrameSize);
                    //for (k = 0; k < fftFrameSize2; k++)
                    //{
                    //    farray.freq_re[k + fftFrameSize2] = farray.freq_re[fftFrameSize2 - 1 - k];
                    //    farray.freq_im[k + fftFrameSize2] = farray.freq_im[fftFrameSize2 - 1 - k];
                    //}
                    //myfourier.fft("reverse", "rect", farray.freq_re, farray.freq_im, farray.time_re, farray.time_im, (int)fftFrameSize);
                    ...
                    for (k = 0; k < fftFrameSize; k++)
                    {
                        ...
                        //localfourier
                        //gOutputAccum[k] += (float)(2.0 * farray.time_re[k] / (fftFrameSize2 * osamp));
                    }
